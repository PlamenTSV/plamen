...
> `prompts/aptos/v2/phase1-recon-prompt.md`; recon receives no MCP and external
...
If Solodit AND Tavily BOTH fail, use this minimum catalog -- check EACH applicable dependency type.
