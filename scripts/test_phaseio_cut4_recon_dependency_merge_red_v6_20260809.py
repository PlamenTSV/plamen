"""V6 live-entry RED denominator for recon fanout, dependency, and merge.
...
def test_v6_accepts_exact_registered_canonical_successor_with_real_output_control(
    tmp_path: Path,
) -> None:
    scratchpad, _config, before, old_key, _old, expected_attempt = (
        _canonical_control_preimage(tmp_path)
...
def test_v6_rejects_uncommitted_canonical_registered_successor(
    tmp_path: Path,
    fault: str,
) -> None:
    scratchpad, _config, before, old_key, _old, expected_attempt = (
